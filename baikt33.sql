create database btkt33_22cntt1a
use btkt33_22cntt1a
...
(
	...
	/*Tạo khóa ngoai*/
	constraint fk_HOCVIEN foreign key(MAHV) references LOPHOC(MALOP)
	on update cascade on delete cascade
)
...
(
	...
	SOBL int not null,
	DIEM int not null,
	KQUA nvarchar not null,
	XEPLOAI nvarchar not null,
	TIENNOP int not null,
	/*Tạo khóa chính*/
	constraint pk_BIENLAI primary key(MAKH),
	/*tạo khóa ngoại*/
	constraint fk_BIENLAI foreign key(MAKH) references GIAOVIEN(MAGV)
	on update cascade on delete cascade
)
